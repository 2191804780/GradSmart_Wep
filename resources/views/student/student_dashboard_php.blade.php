...
<title>GradSmart — لوحة الطالب</title>
...
<div class="main">
  ...
  <?php 
    // استدعاء الشريط العلوي المشترك للطالب
    include $_SERVER['DOCUMENT_ROOT'] . '/GradSmart/layouts/student_topbar.php'; 
  ?>
...
<script>
// نظام تبديل المظهر وحفظ تفضيل المستخدم في المتصفح (Dark/Light Theme)
